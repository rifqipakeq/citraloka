...
import { toIDR, calculateRating } from "@/Utils/helper";
...
export default function Location({
    ...
    const [ticketType, setTicketType] = useState(ticketCategories[0]?.id);

    const [ticketPrice, setTicketPrice] = useState(
        location.ticket.find((t) => t.ticket_category_id === ticketType)
            ?.price_per_pack,
    );
    ...
    const orderTicket = () => {
        ...
        router.post(
            route("payment.handle"),
            {
                ...
                action: "pay",
                ticket_id: location.ticket.find(
                    (ticket) => ticket.ticket_category_id === ticketType,
                )?.id,
            },
            {
            ...
            <UserLayout auth={auth}>
                            ...
                            <div className="mt-8">
                                ...
                                >
                                    <span className="text-xorange">
                                        ...
                                        <span>
                                            {calculateRating(ratingAverages)}
                                        </span>
                                    </span>
                                    <span className="text-gray-500">
                                        {" "}
                ...
                <section className="container mx-auto font-poppins mb-32 px-4">
                    ...
                    <h3 className="text-2xl font-semibold text-gray-500">
                        <span>
                            <i className="bi bi-star-fill"></i>{" "}
                            <span>{calculateRating(ratingAverages)}</span>
                        </span>
