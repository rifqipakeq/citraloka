...
<html lang="en">
  ...
  <body>
    ...
    >
      ...
      >
        <div class="w-full">
          <h1 class="text-4xl font-semibold text-primary-opaque">Maps</h1>
        ...
        <search class="flex flex-col sm:flex-row gap-4 w-full">
          ...
          <button
            type="submit"
            class="py-3.5 px-8 text-white rounded-xl font-semibold bg-primary-opaque"
          >
            Search
          </button>
        </search>
    ...
    <main
      class="container relative mx-auto px-4 grid grid-cols-12 gap-4 sm:gap-12 mt-12 mb-32 z-10 font-poppins"
    >
      <div class="flex flex-col gap-12 col-span-12 md:col-span-4">
        <div class="p-2.5 rounded-3xl border border-gray-300 bg-white">
          ...
          <div class="px-2.5 pb-8">
            ...
            <p class="text-wrap line-clamp-2 text-sm text-gray-400 font-medium">
              ...
              Asperiores explicabo aliquid velit. Necessitatibus culpa, eum
              ipsum asperiores quisquam quaerat ducimus voluptatum corporis
              ullam exercitationem. Velit quis ex id perspiciatis est?
            </p>
          </div>
        </div>
        <div class="p-2.5 rounded-3xl border border-gray-300 bg-white">
