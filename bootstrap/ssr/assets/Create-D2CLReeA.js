...
function Create({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 leading-tight", children: "Create Ticket Category" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Create Ticket Category" }),
        /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(Card, { title: "Create Ticket Category", children: /* @__PURE__ */ jsxs(
          "form",
          {
