...
function Create({ auth, categories }) {
  ...
  return /* @__PURE__ */ jsxs(
    AuthenticatedLayout,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Create Ticket" }),
        /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(Card, { title: "Create Ticket", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleCreateData, children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            ...
            /* @__PURE__ */ jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("option", { value: "", children: "Select Ticket Type" }),
