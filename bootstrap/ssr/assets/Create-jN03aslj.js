...
function Create({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 leading-tight", children: "Create Region" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Create Region" }),
        /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(Card, { title: "Create Region", children: /* @__PURE__ */ jsxs(
          "form",
          {
