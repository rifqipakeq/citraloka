...
function Edit({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 leading-tight", children: "Edit Category" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Edit Category" }),
        /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(Card, { title: "Edit Category", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleUpdateData, children: [
