...
function Edit({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 leading-tight", children: "Edit Region" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Edit Region" }),
        /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(Card, { title: "Edit Region", children: /* @__PURE__ */ jsxs(
          "form",
          {
