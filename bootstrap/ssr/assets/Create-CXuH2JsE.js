...
function Create({ auth }) {
  ...
  const { data, setData, post, errors, progress } = useForm({
    ...
    longitude: "",
    image: []
    // diset array karena multiple images
  });
  ...
  const handleSubmit = (e) => {
    ...
    post(route("locations.store"), {
      data: formData,
      forceFormData: true
      //supaya inertia tahu ini adalah FormData
    });
  };
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      user: auth.user,
      header: /* @__PURE__ */ jsx("h2", { className: "font-semibold text-xl text-gray-800 leading-tight", children: "Add New Location" }),
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Add Location" }),
        /* @__PURE__ */ jsx(Container, { children: /* @__PURE__ */ jsx(Card, { title: "Add Location", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsx(Input, { label: "Title", value: data.title, onChange: (e) => setData("title", e.target.value), errors: errors.title }),
          /* @__PURE__ */ jsx("label", { className: "block mb-1 font-semibold", children: "Description" }),
          /* @__PURE__ */ jsx(
            Editor,
            {
          ...
          /* @__PURE__ */ jsx("label", { className: "block", children: "Category" }),
          /* @__PURE__ */ jsxs("select", { value: data.category_id, onChange: (e) => setData("category_id", e.target.value), className: "w-full p-2 border rounded-sm mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("select", { value: data.region_id, onChange: (e) => setData("region_id", e.target.value), className: "w-full p-2 border rounded-sm mb-4", children: [
          ...
          /* @__PURE__ */ jsx("label", { className: "block mb-1 font-semibold", children: "Images (multiple allowed)" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "file",
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Button, { type: "submit", label: "Submit" }),
